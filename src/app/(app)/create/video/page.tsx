...
const FEATURES = [
  { icon: "🎬", title: "Cinematic presets", desc: "Rolling shot, drift, slow reveal, orbit" },
  { icon: "⚡", title: "5-second clips", desc: "Perfect for Instagram Reels and TikTok" },
  { icon: "🎵", title: "Auto-matched soundtrack", desc: "Music that fits the vibe" },
];
    ...
    <div style={{
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", padding: "48px 24px 32px" }}>
        ...
        <div style={{
          ...
          <span style={{ fontSize: 80, opacity: 0.3, filter: "drop-shadow(0 0 12px #44CCFF)" }}>🎬</span>
        </div>
        ...
        <p style={{
          ...
          Turn any build into a cinematic video clip.
          Rolling shots, drifting, slow reveals — all from a single photo.
        </p>
