...
const MOCK_BOARDS = [
  { id: "board1", name: "Liked Builds", count: 12, privacy: "Private", images: ["https://images.unsplash.com/photo-1511919884226-fd3cad34687c?w=200&q=80&fm=webp", "https://images.unsplash.com/photo-1544636331-e26879cd4d9b?w=200&q=80&fm=webp", "https://images.unsplash.com/photo-1552519507-da3b142c6e3d?w=200&q=80&fm=webp", "https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?w=200&q=80&fm=webp"] },
  { id: "board2", name: "My Next Build", count: 7, privacy: "Private", images: ["https://images.unsplash.com/photo-1580273916550-e323be2ae537?w=200&q=80&fm=webp", "https://images.unsplash.com/photo-1618843479313-40f8afb4b4d8?w=200&q=80&fm=webp", "https://images.unsplash.com/photo-1568605117036-5fe5e7bab0b7?w=200&q=80&fm=webp", "https://images.unsplash.com/photo-1583121274602-3e2820c69888?w=200&q=80&fm=webp"] },
  { id: "board3", name: "Civic Inspo", count: 5, privacy: "Public", images: ["https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=200&q=80&fm=webp", "https://images.unsplash.com/photo-1605559424843-9e4c228bf1c2?w=200&q=80&fm=webp", "https://images.unsplash.com/photo-1494976388531-d1058494cdd8?w=200&q=80&fm=webp", "https://images.unsplash.com/photo-1511919884226-fd3cad34687c?w=200&q=80&fm=webp"] },
];
...
export default function GaragePage() {
  ...
  const [activeTab, setActiveTab] = useState<"vehicles" | "builds" | "boards">("vehicles");
  ...
  return (
    <div style={{ background: "var(--color-bg)", minHeight: "100vh", paddingBottom: 96 }}>
      ...
      {!hasVehicles ? (
        ...
        <div>
          {/* Tab bar */}
          <div style={{ display: "flex", gap: 0, padding: "0 20px", borderBottom: "1px solid var(--color-border)", marginBottom: 24 }}>
            {[
              ...
              <button
                ...
                style={{
                  ...
                  padding: "14px 20px 13px", fontSize: 14, fontWeight: 600,
                  color: activeTab === tab.id ? "#44CCFF" : "var(--color-text-secondary)",
                  borderBottom: `2px solid ${activeTab === tab.id ? "#44CCFF" : "transparent"}`,
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(200px, 1fr))", gap: 14, marginBottom: 36 }}>
                {MOCK_BOARDS.map((board) => (
                  <div key={board.id} style={{ cursor: "pointer" }}>
                    <div style={{ width: "100%", aspectRatio: "1/1", borderRadius: 16, overflow: "hidden", display: "grid", gridTemplateColumns: "1fr 1fr", gridTemplateRows: "1fr 1fr", gap: 2, background: "var(--color-surface-elevated)" }}>
                      {board.images.map((img, i) => (
                        <img key={i} src={img} alt="" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                      ))}
                    </div>
                    <p style={{ fontFamily: "var(--font-manrope, Manrope, sans-serif)", fontWeight: 700, fontSize: 14, color: "var(--color-text-primary)", margin: "8px 0 2px" }}>{board.name}</p>
                    <p style={{ fontSize: 12, color: "var(--color-text-tertiary)", margin: 0 }}>{board.count} builds · {board.privacy}</p>
                  </div>
                ))}
                {/* Create new board */}
                <div style={{ cursor: "pointer" }}>
                  <div style={{ width: "100%", aspectRatio: "1/1", borderRadius: 16, background: "rgba(68,204,255,0.04)", border: "2px dashed rgba(68,204,255,0.25)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                    <span style={{ fontSize: 32, color: "#44CCFF", fontWeight: 300 }}>+</span>
                  </div>
                  <p style={{ fontFamily: "var(--font-manrope, Manrope, sans-serif)", fontWeight: 700, fontSize: 14, color: "var(--color-text-tertiary)", margin: "8px 0 2px" }}>New Board</p>
                  <p style={{ fontSize: 12, color: "var(--color-text-tertiary)", margin: 0 }}>Create a collection</p>
                </div>
              </div>
            </div>
          )}
      ...
      <button
        ...
        style={{
          ...
          alignItems: "center",
          justifyContent: "center",
          boxShadow: "0 4px 24px rgba(68,204,255,0.45)",
          zIndex: 100,
          fontSize: 28,
          fontWeight: 300,
          lineHeight: 1,
